...
function SignupSigninComponent() {
    ...
    return (
        <>
            {loginForm ? (<div className="sign-wrapper">
                <h2 className="title">
                ...
                <form>
                    ...
                    <p className="p-login" style={{ cursor: "pointer" }} onClick={() => setLoginForm(!loginForm)}>or don't Have An Account Alredy? click here</p>
                </form>
            </div>) : (<div className="sign-wrapper">
                <h2 className="title">
